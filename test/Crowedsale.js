...
describe('Staking', () => {
  ...
  describe('buyTokens', () => {
    it('adds a token symbol', async () => {
      ...
      totalSupply = await tokenCoin.totalSupply()
      signer2Balance = await tokenCoin.balanceOf(signer2.address)
      signer3Balance = await tokenCoin.balanceOf(signer3.address)
      ...
      totalSupply = await tokenCoin.totalSupply()
      signer2Balance = await tokenCoin.connect(owner).balanceOf(signer2.address)
      signer3Balance = await tokenCoin.connect(owner).balanceOf(signer3.address)
